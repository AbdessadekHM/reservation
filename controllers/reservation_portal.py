...
class ReservationPortal(CustomerPortal):
    ...
    def get_reservations(
        self, search=None, filterby=None, sortby=None, search_in="content"
    ):
    ...
    def get_reservation(self, id):
        ...
        reservation = request.env["reservation.reservation"].search([("id", "=", id)])

        return request.render(
            "reservation.portal_my_reservation_detail",
            {"reservation": reservation, "page_name": "reservation detail"},
        )
    ...
    def get_pdf(self, id):
        ...
        http_headers = {
            ...
            (
                "Content-Disposition",
                f'attachement; filename="Reservation_{reservation.name}.pdf"',
            ),
        }
